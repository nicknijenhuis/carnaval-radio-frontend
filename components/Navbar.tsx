  ...
  return (
    <div className="w-full fixed top-0 left-0 bg-[#E63A3A] z-10">
      <div className="md:flex items-center justify-between text-white py-4 md:px-20 px-7 max-w-[1280px] m-auto">
        ...
        <ul
          className={`flex flex-col md:flex-row md:items-center md:pb-0 pb-12 absolute bg-[#E63A3A] md:bg-transparent md:static md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${
